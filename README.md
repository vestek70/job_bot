...
| The Muse | Software Engineering, фильтр по Бразилии/удалёнке; единственный, кто даёт и офисные в Бразилии | Нет | `ENABLE_THEMUSE=0` |
...
- 6 источников вместо одного (Adzuna + 5 доп.).
